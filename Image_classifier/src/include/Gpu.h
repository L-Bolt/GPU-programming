...
class Gpu {
    public:
        ...
        void forward_prop(std::vector<Image> *input, std::vector<std::vector<double>> *a1, std::vector<std::vector<double>> *a2, std::vector<std::vector<double>> *z1, Matrix2D<double> *weights0, Matrix2D<double> *weights1, Matrix2D<double> *bias0, Matrix2D<double> *bias1);
